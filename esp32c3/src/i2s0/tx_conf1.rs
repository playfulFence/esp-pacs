...
#[doc = "Field `TX_TDM_WS_WIDTH` reader - The width of tx_ws_out in TDM mode is (reg_tx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
pub type TX_TDM_WS_WIDTH_R = crate::FieldReader;
#[doc = "Field `TX_TDM_WS_WIDTH` writer - The width of tx_ws_out in TDM mode is (reg_tx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
...
#[doc = "Field `TX_BITS_MOD` reader - Set the bits to configure bit length of I2S transmitter channel."]
pub type TX_BITS_MOD_R = crate::FieldReader;
#[doc = "Field `TX_BITS_MOD` writer - Set the bits to configure bit length of I2S transmitter channel."]
...
impl R {
    #[doc = "Bits 0:6 - The width of tx_ws_out in TDM mode is (reg_tx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
    #[inline(always)]
    ...
    #[doc = "Bits 13:17 - Set the bits to configure bit length of I2S transmitter channel."]
    #[inline(always)]
