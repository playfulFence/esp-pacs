...
#[doc = "Field `TX_CHAN_EQUAL` reader - 1: The value of Left channel data is equal to the value of right"]
pub type TX_CHAN_EQUAL_R = crate::BitReader;
#[doc = "Field `TX_CHAN_EQUAL` writer - 1: The value of Left channel data is equal to the value of right"]
pub type TX_CHAN_EQUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_BIG_ENDIAN` reader - I2S Tx byte endian 1: low addr value to high addr. 0: low addr"]
pub type TX_BIG_ENDIAN_R = crate::BitReader;
#[doc = "Field `TX_BIG_ENDIAN` writer - I2S Tx byte endian 1: low addr value to high addr. 0: low addr"]
pub type TX_BIG_ENDIAN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_UPDATE` reader - Set 1 to update I2S TX registers from APB clock domain to I2S"]
pub type TX_UPDATE_R = crate::BitReader;
#[doc = "Field `TX_UPDATE` writer - Set 1 to update I2S TX registers from APB clock domain to I2S"]
pub type TX_UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_MONO_FST_VLD` reader - 1: The first channel data value is valid in I2S TX mono mode."]
pub type TX_MONO_FST_VLD_R = crate::BitReader;
#[doc = "Field `TX_MONO_FST_VLD` writer - 1: The first channel data value is valid in I2S TX mono mode."]
pub type TX_MONO_FST_VLD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_PCM_CONF` reader - I2S TX compress/decompress configuration bit. & 0 (atol): A-Law"]
pub type TX_PCM_CONF_R = crate::FieldReader;
#[doc = "Field `TX_PCM_CONF` writer - I2S TX compress/decompress configuration bit. & 0 (atol): A-Law"]
...
#[doc = "Field `TX_STOP_EN` reader - Set this bit to stop disable output BCK signal and WS signal"]
pub type TX_STOP_EN_R = crate::BitReader;
#[doc = "Field `TX_STOP_EN` writer - Set this bit to stop disable output BCK signal and WS signal"]
...
#[doc = "Field `TX_WS_IDLE_POL` reader - 0: WS should be 0 when sending left channel data and WS is 1in"]
pub type TX_WS_IDLE_POL_R = crate::BitReader;
#[doc = "Field `TX_WS_IDLE_POL` writer - 0: WS should be 0 when sending left channel data and WS is 1in"]
pub type TX_WS_IDLE_POL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TX_BIT_ORDER` reader - I2S Tx bit endian. 1:small endian the LSB is sent first. 0:big"]
pub type TX_BIT_ORDER_R = crate::BitReader;
#[doc = "Field `TX_BIT_ORDER` writer - I2S Tx bit endian. 1:small endian the LSB is sent first. 0:big"]
...
#[doc = "Field `SIG_LOOPBACK` reader - Enable signal loop back mode with transmitter module and receiver"]
pub type SIG_LOOPBACK_R = crate::BitReader;
#[doc = "Field `SIG_LOOPBACK` writer - Enable signal loop back mode with transmitter module and receiver"]
...
impl R {
    ...
    #[doc = "Bit 6 - 1: The value of Left channel data is equal to the value of right"]
    #[inline(always)]
    pub fn tx_chan_equal(&self) -> TX_CHAN_EQUAL_R {
        TX_CHAN_EQUAL_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - I2S Tx byte endian 1: low addr value to high addr. 0: low addr"]
    #[inline(always)]
    pub fn tx_big_endian(&self) -> TX_BIG_ENDIAN_R {
        TX_BIG_ENDIAN_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - Set 1 to update I2S TX registers from APB clock domain to I2S"]
    #[inline(always)]
    pub fn tx_update(&self) -> TX_UPDATE_R {
        TX_UPDATE_R::new(((self.bits >> 8) & 1) != 0)
    }
    #[doc = "Bit 9 - 1: The first channel data value is valid in I2S TX mono mode."]
    #[inline(always)]
    pub fn tx_mono_fst_vld(&self) -> TX_MONO_FST_VLD_R {
        TX_MONO_FST_VLD_R::new(((self.bits >> 9) & 1) != 0)
    }
    #[doc = "Bits 10:11 - I2S TX compress/decompress configuration bit. & 0 (atol): A-Law"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Set this bit to stop disable output BCK signal and WS signal"]
    #[inline(always)]
    ...
    #[doc = "Bit 17 - 0: WS should be 0 when sending left channel data and WS is 1in"]
    #[inline(always)]
    pub fn tx_ws_idle_pol(&self) -> TX_WS_IDLE_POL_R {
        TX_WS_IDLE_POL_R::new(((self.bits >> 17) & 1) != 0)
    }
    #[doc = "Bit 18 - I2S Tx bit endian. 1:small endian the LSB is sent first. 0:big"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - Enable signal loop back mode with transmitter module and receiver"]
    #[inline(always)]
