...
#[doc = "Field `SINGLE_DATA` reader - the right channel or left channel put out constant value stored"]
pub type SINGLE_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `SINGLE_DATA` writer - the right channel or left channel put out constant value stored"]
pub type SINGLE_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - the right channel or left channel put out constant value stored"]
    #[inline(always)]
