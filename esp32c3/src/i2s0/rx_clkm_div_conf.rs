...
#[doc = "Field `RX_CLKM_DIV_Z` reader - For b <= a/2 the value of I2S_RX_CLKM_DIV_Z is b. For b > a/2"]
pub type RX_CLKM_DIV_Z_R = crate::FieldReader<u16>;
#[doc = "Field `RX_CLKM_DIV_Z` writer - For b <= a/2 the value of I2S_RX_CLKM_DIV_Z is b. For b > a/2"]
pub type RX_CLKM_DIV_Z_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `RX_CLKM_DIV_Y` reader - For b <= a/2 the value of I2S_RX_CLKM_DIV_Y is (a%b) . For b"]
pub type RX_CLKM_DIV_Y_R = crate::FieldReader<u16>;
#[doc = "Field `RX_CLKM_DIV_Y` writer - For b <= a/2 the value of I2S_RX_CLKM_DIV_Y is (a%b) . For b"]
pub type RX_CLKM_DIV_Y_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `RX_CLKM_DIV_X` reader - For b <= a/2 the value of I2S_RX_CLKM_DIV_X is (a/b) - 1. For"]
pub type RX_CLKM_DIV_X_R = crate::FieldReader<u16>;
#[doc = "Field `RX_CLKM_DIV_X` writer - For b <= a/2 the value of I2S_RX_CLKM_DIV_X is (a/b) - 1. For"]
pub type RX_CLKM_DIV_X_W<'a, REG> = crate::FieldWriter<'a, REG, 9, u16>;
#[doc = "Field `RX_CLKM_DIV_YN1` reader - For b <= a/2 the value of I2S_RX_CLKM_DIV_YN1 is 0 . For b >"]
pub type RX_CLKM_DIV_YN1_R = crate::BitReader;
#[doc = "Field `RX_CLKM_DIV_YN1` writer - For b <= a/2 the value of I2S_RX_CLKM_DIV_YN1 is 0 . For b >"]
pub type RX_CLKM_DIV_YN1_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bits 0:8 - For b <= a/2 the value of I2S_RX_CLKM_DIV_Z is b. For b > a/2"]
    #[inline(always)]
    pub fn rx_clkm_div_z(&self) -> RX_CLKM_DIV_Z_R {
        RX_CLKM_DIV_Z_R::new((self.bits & 0x01ff) as u16)
    }
    #[doc = "Bits 9:17 - For b <= a/2 the value of I2S_RX_CLKM_DIV_Y is (a%b) . For b"]
    #[inline(always)]
    pub fn rx_clkm_div_y(&self) -> RX_CLKM_DIV_Y_R {
        RX_CLKM_DIV_Y_R::new(((self.bits >> 9) & 0x01ff) as u16)
    }
    #[doc = "Bits 18:26 - For b <= a/2 the value of I2S_RX_CLKM_DIV_X is (a/b) - 1. For"]
    #[inline(always)]
    pub fn rx_clkm_div_x(&self) -> RX_CLKM_DIV_X_R {
        RX_CLKM_DIV_X_R::new(((self.bits >> 18) & 0x01ff) as u16)
    }
    #[doc = "Bit 27 - For b <= a/2 the value of I2S_RX_CLKM_DIV_YN1 is 0 . For b >"]
    #[inline(always)]
