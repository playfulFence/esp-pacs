...
#[doc = "Field `RX_TDM_WS_WIDTH` reader - The width of rx_ws_out in TDM mode is (reg_rx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
pub type RX_TDM_WS_WIDTH_R = crate::FieldReader;
#[doc = "Field `RX_TDM_WS_WIDTH` writer - The width of rx_ws_out in TDM mode is (reg_rx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
...
#[doc = "Field `RX_BITS_MOD` reader - Set the bits to configure bit length of I2S receiver channel."]
pub type RX_BITS_MOD_R = crate::FieldReader;
#[doc = "Field `RX_BITS_MOD` writer - Set the bits to configure bit length of I2S receiver channel."]
...
impl R {
    #[doc = "Bits 0:6 - The width of rx_ws_out in TDM mode is (reg_rx_tdm_ws_width\\[6:0\\] +1) * T_bck"]
    #[inline(always)]
    ...
    #[doc = "Bits 13:17 - Set the bits to configure bit length of I2S receiver channel."]
    #[inline(always)]
