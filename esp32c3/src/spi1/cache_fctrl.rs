...
#[doc = "Field `FDIN_DUAL` reader - For SPI1 din phase apply 2 signals. 1: enable 0: disable. The"]
pub type FDIN_DUAL_R = crate::BitReader;
#[doc = "Field `FDIN_DUAL` writer - For SPI1 din phase apply 2 signals. 1: enable 0: disable. The"]
pub type FDIN_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FDOUT_DUAL` reader - For SPI1 dout phase apply 2 signals. 1: enable 0: disable. The"]
pub type FDOUT_DUAL_R = crate::BitReader;
#[doc = "Field `FDOUT_DUAL` writer - For SPI1 dout phase apply 2 signals. 1: enable 0: disable. The"]
pub type FDOUT_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FADDR_DUAL` reader - For SPI1 address phase apply 2 signals. 1: enable 0: disable."]
pub type FADDR_DUAL_R = crate::BitReader;
#[doc = "Field `FADDR_DUAL` writer - For SPI1 address phase apply 2 signals. 1: enable 0: disable."]
pub type FADDR_DUAL_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FDIN_QUAD` reader - For SPI1 din phase apply 4 signals. 1: enable 0: disable. The"]
pub type FDIN_QUAD_R = crate::BitReader;
#[doc = "Field `FDIN_QUAD` writer - For SPI1 din phase apply 4 signals. 1: enable 0: disable. The"]
pub type FDIN_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FDOUT_QUAD` reader - For SPI1 dout phase apply 4 signals. 1: enable 0: disable."]
pub type FDOUT_QUAD_R = crate::BitReader;
#[doc = "Field `FDOUT_QUAD` writer - For SPI1 dout phase apply 4 signals. 1: enable 0: disable."]
pub type FDOUT_QUAD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `FADDR_QUAD` reader - For SPI1 address phase apply 4 signals. 1: enable 0: disable."]
pub type FADDR_QUAD_R = crate::BitReader;
#[doc = "Field `FADDR_QUAD` writer - For SPI1 address phase apply 4 signals. 1: enable 0: disable."]
...
impl R {
    ...
    #[doc = "Bit 3 - For SPI1 din phase apply 2 signals. 1: enable 0: disable. The"]
    #[inline(always)]
    pub fn fdin_dual(&self) -> FDIN_DUAL_R {
        FDIN_DUAL_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - For SPI1 dout phase apply 2 signals. 1: enable 0: disable. The"]
    #[inline(always)]
    pub fn fdout_dual(&self) -> FDOUT_DUAL_R {
        FDOUT_DUAL_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - For SPI1 address phase apply 2 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn faddr_dual(&self) -> FADDR_DUAL_R {
        FADDR_DUAL_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - For SPI1 din phase apply 4 signals. 1: enable 0: disable. The"]
    #[inline(always)]
    pub fn fdin_quad(&self) -> FDIN_QUAD_R {
        FDIN_QUAD_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - For SPI1 dout phase apply 4 signals. 1: enable 0: disable."]
    #[inline(always)]
    pub fn fdout_quad(&self) -> FDOUT_QUAD_R {
        FDOUT_QUAD_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bit 8 - For SPI1 address phase apply 4 signals. 1: enable 0: disable."]
    #[inline(always)]
