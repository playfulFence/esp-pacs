...
#[doc = "Field `WAIT_PESR_COMMAND` reader - Flash SUS/SUS1/SUS2 status bit read command. The command should"]
pub type WAIT_PESR_COMMAND_R = crate::FieldReader<u16>;
#[doc = "Field `WAIT_PESR_COMMAND` writer - Flash SUS/SUS1/SUS2 status bit read command. The command should"]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Flash SUS/SUS1/SUS2 status bit read command. The command should"]
    #[inline(always)]
