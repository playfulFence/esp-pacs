...
#[doc = "Field `USR_ADDR_VALUE` reader - In user mode it is the memory address. other then the bit0-bit23"]
pub type USR_ADDR_VALUE_R = crate::FieldReader<u32>;
#[doc = "Field `USR_ADDR_VALUE` writer - In user mode it is the memory address. other then the bit0-bit23"]
pub type USR_ADDR_VALUE_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - In user mode it is the memory address. other then the bit0-bit23"]
    #[inline(always)]
