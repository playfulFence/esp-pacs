...
#[doc = "Field `FMEM_RD_SUS_2B` reader - 1: Read two bytes when check flash SUS/SUS1/SUS2 status bit."]
pub type FMEM_RD_SUS_2B_R = crate::BitReader;
#[doc = "Field `FMEM_RD_SUS_2B` writer - 1: Read two bytes when check flash SUS/SUS1/SUS2 status bit."]
