...
#[doc = "Field `TX_BRK_NUM` reader - This register is used to configure the number of 0 to be sent"]
pub type TX_BRK_NUM_R = crate::FieldReader;
#[doc = "Field `TX_BRK_NUM` writer - This register is used to configure the number of 0 to be sent"]
pub type TX_BRK_NUM_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 0:7 - This register is used to configure the number of 0 to be sent"]
    #[inline(always)]
