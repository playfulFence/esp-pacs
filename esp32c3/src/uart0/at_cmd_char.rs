...
#[doc = "Field `CHAR_NUM` reader - This register is used to configure the num of continuous at_cmd"]
pub type CHAR_NUM_R = crate::FieldReader;
#[doc = "Field `CHAR_NUM` writer - This register is used to configure the num of continuous at_cmd"]
...
impl R {
    ...
    #[doc = "Bits 8:15 - This register is used to configure the num of continuous at_cmd"]
    #[inline(always)]
