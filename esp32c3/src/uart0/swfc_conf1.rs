...
#[doc = "Field `XON_THRESHOLD` reader - When the data amount in Rx-FIFO is less than this register value"]
pub type XON_THRESHOLD_R = crate::FieldReader<u16>;
#[doc = "Field `XON_THRESHOLD` writer - When the data amount in Rx-FIFO is less than this register value"]
...
impl R {
    #[doc = "Bits 0:8 - When the data amount in Rx-FIFO is less than this register value"]
    #[inline(always)]
