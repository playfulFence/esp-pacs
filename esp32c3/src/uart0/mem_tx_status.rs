...
#[doc = "Field `APB_TX_WADDR` reader - This register stores the offset address in Tx-FIFO when software"]
pub type APB_TX_WADDR_R = crate::FieldReader<u16>;
#[doc = "Field `TX_RADDR` reader - This register stores the offset address in Tx-FIFO when Tx-FSM"]
pub type TX_RADDR_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:9 - This register stores the offset address in Tx-FIFO when software"]
    #[inline(always)]
    pub fn apb_tx_waddr(&self) -> APB_TX_WADDR_R {
        APB_TX_WADDR_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 11:20 - This register stores the offset address in Tx-FIFO when Tx-FSM"]
    #[inline(always)]
