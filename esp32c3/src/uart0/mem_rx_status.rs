...
#[doc = "Field `APB_RX_RADDR` reader - This register stores the offset address in RX-FIFO when software"]
pub type APB_RX_RADDR_R = crate::FieldReader<u16>;
#[doc = "Field `RX_WADDR` reader - This register stores the offset address in Rx-FIFO when Rx-FIFO_Ctrl"]
pub type RX_WADDR_R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:9 - This register stores the offset address in RX-FIFO when software"]
    #[inline(always)]
    pub fn apb_rx_raddr(&self) -> APB_RX_RADDR_R {
        APB_RX_RADDR_R::new((self.bits & 0x03ff) as u16)
    }
    #[doc = "Bits 11:20 - This register stores the offset address in Rx-FIFO when Rx-FIFO_Ctrl"]
    #[inline(always)]
