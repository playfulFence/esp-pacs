...
impl W {
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn area_dram0_0_rd_ena(&mut self) -> AREA_DRAM0_0_RD_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_DRAM0_0_RD_ENA_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn area_dram0_0_wr_ena(&mut self) -> AREA_DRAM0_0_WR_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_DRAM0_0_WR_ENA_W::new(self, 1)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn area_dram0_1_rd_ena(&mut self) -> AREA_DRAM0_1_RD_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_DRAM0_1_RD_ENA_W::new(self, 2)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn area_dram0_1_wr_ena(&mut self) -> AREA_DRAM0_1_WR_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_DRAM0_1_WR_ENA_W::new(self, 3)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn area_pif_0_rd_ena(&mut self) -> AREA_PIF_0_RD_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_PIF_0_RD_ENA_W::new(self, 4)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    pub fn area_pif_0_wr_ena(&mut self) -> AREA_PIF_0_WR_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_PIF_0_WR_ENA_W::new(self, 5)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    pub fn area_pif_1_rd_ena(&mut self) -> AREA_PIF_1_RD_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_PIF_1_RD_ENA_W::new(self, 6)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn area_pif_1_wr_ena(&mut self) -> AREA_PIF_1_WR_ENA_W<'_, INTR_ENA_SPEC> {
        AREA_PIF_1_WR_ENA_W::new(self, 7)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    pub fn sp_spill_min_ena(&mut self) -> SP_SPILL_MIN_ENA_W<'_, INTR_ENA_SPEC> {
        SP_SPILL_MIN_ENA_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    pub fn sp_spill_max_ena(&mut self) -> SP_SPILL_MAX_ENA_W<'_, INTR_ENA_SPEC> {
    ...
    pub fn iram0_exception_monitor_ena(
        &mut self,
    ) -> IRAM0_EXCEPTION_MONITOR_ENA_W<'_, INTR_ENA_SPEC> {
    ...
    pub fn dram0_exception_monitor_ena(
        &mut self,
    ) -> DRAM0_EXCEPTION_MONITOR_ENA_W<'_, INTR_ENA_SPEC> {
