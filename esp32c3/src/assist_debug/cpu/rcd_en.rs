...
#[doc = "Field `RCD_RECORDEN` reader - enable recording function if enable assist_debug will update"]
pub type RCD_RECORDEN_R = crate::BitReader;
#[doc = "Field `RCD_RECORDEN` writer - enable recording function if enable assist_debug will update"]
pub type RCD_RECORDEN_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `RCD_PDEBUGEN` reader - enable CPU Pdebug function if enable CPU will update PdebugPC"]
pub type RCD_PDEBUGEN_R = crate::BitReader;
#[doc = "Field `RCD_PDEBUGEN` writer - enable CPU Pdebug function if enable CPU will update PdebugPC"]
pub type RCD_PDEBUGEN_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - enable recording function if enable assist_debug will update"]
    #[inline(always)]
    pub fn rcd_recorden(&self) -> RCD_RECORDEN_R {
        RCD_RECORDEN_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - enable CPU Pdebug function if enable CPU will update PdebugPC"]
    #[inline(always)]
