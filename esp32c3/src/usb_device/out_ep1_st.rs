...
impl R {
    #[doc = "Bits 0:2 - State of OUT Endpoint 1. /"]
    #[inline(always)]
    pub fn out_ep1_state(&self) -> OUT_EP1_STATE_R {
        OUT_EP1_STATE_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 2:9 - Write data address of OUT endpoint 1. When USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT is detected. there are USB_SERIAL_JTAG_OUT_EP1_WR_ADDR-2 bytes data in OUT EP1. /"]
    #[inline(always)]
    pub fn out_ep1_wr_addr(&self) -> OUT_EP1_WR_ADDR_R {
        OUT_EP1_WR_ADDR_R::new(((self.bits >> 2) & 0xff) as u8)
    }
    #[doc = "Bits 9:16 - Read data address of OUT endpoint 1. /"]
    #[inline(always)]
    pub fn out_ep1_rd_addr(&self) -> OUT_EP1_RD_ADDR_R {
        OUT_EP1_RD_ADDR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
    #[doc = "Bits 16:23 - Data count in OUT endpoint 1 when one packet is received. /"]
    #[inline(always)]
    pub fn out_ep1_rec_data_cnt(&self) -> OUT_EP1_REC_DATA_CNT_R {
        OUT_EP1_REC_DATA_CNT_R::new(((self.bits >> 16) & 0xff) as u8)
    }
}
