...
impl R {
    #[doc = "Bits 0:2 - State of OUT Endpoint 0. /"]
    #[inline(always)]
    pub fn out_ep0_state(&self) -> OUT_EP0_STATE_R {
        OUT_EP0_STATE_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 2:9 - Write data address of OUT endpoint 0. When USB_SERIAL_JTAG_SERIAL_OUT_RECV_PKT_INT is detected. there are USB_SERIAL_JTAG_OUT_EP0_WR_ADDR-2 bytes data in OUT EP0. /"]
    #[inline(always)]
    pub fn out_ep0_wr_addr(&self) -> OUT_EP0_WR_ADDR_R {
        OUT_EP0_WR_ADDR_R::new(((self.bits >> 2) & 0xff) as u8)
    }
    #[doc = "Bits 9:16 - Read data address of OUT endpoint 0. /"]
    #[inline(always)]
    pub fn out_ep0_rd_addr(&self) -> OUT_EP0_RD_ADDR_R {
        OUT_EP0_RD_ADDR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
}
