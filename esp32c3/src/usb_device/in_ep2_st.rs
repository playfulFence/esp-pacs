...
impl R {
    #[doc = "Bits 0:2 - State of IN Endpoint 2. /"]
    #[inline(always)]
    pub fn in_ep2_state(&self) -> IN_EP2_STATE_R {
        IN_EP2_STATE_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 2:9 - Write data address of IN endpoint 2. /"]
    #[inline(always)]
    pub fn in_ep2_wr_addr(&self) -> IN_EP2_WR_ADDR_R {
        IN_EP2_WR_ADDR_R::new(((self.bits >> 2) & 0xff) as u8)
    }
    #[doc = "Bits 9:16 - Read data address of IN endpoint 2. /"]
    #[inline(always)]
    pub fn in_ep2_rd_addr(&self) -> IN_EP2_RD_ADDR_R {
        IN_EP2_RD_ADDR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets IN_EP2_ST to value 0"]
