...
#[doc = "Field `PHY_SEL` reader - Select internal/external PHY. 1’b0: internal PHY, 1’b1: external PHY /"]
pub type PHY_SEL_R = crate::BitReader;
#[doc = "Field `PHY_SEL` writer - Select internal/external PHY. 1’b0: internal PHY, 1’b1: external PHY /"]
...
#[doc = "Field `VREFL` reader - Control single-end input high threshold. 1.76V to 2V, step 80mV /"]
pub type VREFL_R = crate::FieldReader;
#[doc = "Field `VREFL` writer - Control single-end input high threshold. 1.76V to 2V, step 80mV /"]
pub type VREFL_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `VREFH` reader - Control single-end input low threshold. 0.8V to 1.04V, step 80mV /"]
pub type VREFH_R = crate::FieldReader;
#[doc = "Field `VREFH` writer - Control single-end input low threshold. 0.8V to 1.04V, step 80mV /"]
pub type VREFH_W<'a, REG> = crate::FieldWriter<'a, REG, 3>;
...
impl R {
    #[doc = "Bit 0 - Select internal/external PHY. 1’b0: internal PHY, 1’b1: external PHY /"]
    #[inline(always)]
    ...
    #[doc = "Bits 3:5 - Control single-end input high threshold. 1.76V to 2V, step 80mV /"]
    #[inline(always)]
    pub fn vrefl(&self) -> VREFL_R {
        VREFL_R::new(((self.bits >> 3) & 7) as u8)
    }
    #[doc = "Bits 5:7 - Control single-end input low threshold. 0.8V to 1.04V, step 80mV /"]
    #[inline(always)]
    pub fn vrefh(&self) -> VREFH_R {
        VREFH_R::new(((self.bits >> 5) & 7) as u8)
    }
