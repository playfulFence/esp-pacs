...
impl R {
    #[doc = "Bits 0:2 - State of IN Endpoint 0. /"]
    #[inline(always)]
    pub fn in_ep0_state(&self) -> IN_EP0_STATE_R {
        IN_EP0_STATE_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 2:9 - Write data address of IN endpoint 0. /"]
    #[inline(always)]
    pub fn in_ep0_wr_addr(&self) -> IN_EP0_WR_ADDR_R {
        IN_EP0_WR_ADDR_R::new(((self.bits >> 2) & 0xff) as u8)
    }
    #[doc = "Bits 9:16 - Read data address of IN endpoint 0. /"]
    #[inline(always)]
    pub fn in_ep0_rd_addr(&self) -> IN_EP0_RD_ADDR_R {
        IN_EP0_RD_ADDR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets IN_EP0_ST to value 0"]
