...
impl R {
    #[doc = "Bits 0:2 - State of IN Endpoint 3. /"]
    #[inline(always)]
    pub fn in_ep3_state(&self) -> IN_EP3_STATE_R {
        IN_EP3_STATE_R::new((self.bits & 7) as u8)
    }
    #[doc = "Bits 2:9 - Write data address of IN endpoint 3. /"]
    #[inline(always)]
    pub fn in_ep3_wr_addr(&self) -> IN_EP3_WR_ADDR_R {
        IN_EP3_WR_ADDR_R::new(((self.bits >> 2) & 0xff) as u8)
    }
    #[doc = "Bits 9:16 - Read data address of IN endpoint 3. /"]
    #[inline(always)]
    pub fn in_ep3_rd_addr(&self) -> IN_EP3_RD_ADDR_R {
        IN_EP3_RD_ADDR_R::new(((self.bits >> 9) & 0xff) as u8)
    }
}
...
#[doc = "`reset()` method sets IN_EP3_ST to value 0"]
