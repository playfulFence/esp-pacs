...
impl RegisterBlock {
    ...
    #[doc = "0x10 - CH0_TX_CONF0"]
    #[inline(always)]
    pub const fn ch0_tx_conf0(&self) -> &CH_TX_CONF0 {
        self.ch_tx_conf0(0)
    }
    #[doc = "0x14 - CH1_TX_CONF0"]
    #[inline(always)]
    ...
    #[doc = "0x18 - CH2_RX_CONF0"]
    #[inline(always)]
    pub const fn ch2_rx_conf0(&self) -> &CH_RX_CONF0 {
        self.ch_rx_conf0(0)
    }
    #[doc = "0x20 - CH3_RX_CONF0"]
    #[inline(always)]
    ...
    #[doc = "0x1c - CH2_RX_CONF1"]
    #[inline(always)]
    pub const fn ch2_rx_conf1(&self) -> &CH_RX_CONF1 {
        self.ch_rx_conf1(0)
    }
    #[doc = "0x24 - CH3_RX_CONF1"]
    #[inline(always)]
    ...
    #[doc = "0x28 - CH0_TX_STATUS"]
    #[inline(always)]
    pub const fn ch0_tx_status(&self) -> &CH_TX_STATUS {
        self.ch_tx_status(0)
    }
    #[doc = "0x2c - CH1_TX_STATUS"]
    #[inline(always)]
    ...
    #[doc = "0x30 - CH2_RX_STATUS"]
    #[inline(always)]
    pub const fn ch2_rx_status(&self) -> &CH_RX_STATUS {
        self.ch_rx_status(0)
    }
    #[doc = "0x34 - CH3_RX_STATUS"]
    #[inline(always)]
    ...
    #[doc = "0xcc - AES version control register"]
    #[inline(always)]
