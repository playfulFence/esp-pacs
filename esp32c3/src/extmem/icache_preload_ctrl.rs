...
#[doc = "Field `ICACHE_PRELOAD_ENA` reader - The bit is used to enable preload operation. It will be cleared"]
pub type ICACHE_PRELOAD_ENA_R = crate::BitReader;
#[doc = "Field `ICACHE_PRELOAD_ENA` writer - The bit is used to enable preload operation. It will be cleared"]
...
#[doc = "Field `ICACHE_PRELOAD_ORDER` reader - The bit is used to configure the direction of preload operation."]
pub type ICACHE_PRELOAD_ORDER_R = crate::BitReader;
#[doc = "Field `ICACHE_PRELOAD_ORDER` writer - The bit is used to configure the direction of preload operation."]
pub type ICACHE_PRELOAD_ORDER_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - The bit is used to enable preload operation. It will be cleared"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - The bit is used to configure the direction of preload operation."]
    #[inline(always)]
