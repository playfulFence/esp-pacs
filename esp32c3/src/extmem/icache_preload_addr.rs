...
#[doc = "Field `ICACHE_PRELOAD_ADDR` reader - The bits are used to configure the start virtual address for"]
pub type ICACHE_PRELOAD_ADDR_R = crate::FieldReader<u32>;
#[doc = "Field `ICACHE_PRELOAD_ADDR` writer - The bits are used to configure the start virtual address for"]
