...
#[doc = "Field `CORE0_IBUS_ACS_MSK_ICACHE` reader - The bit is used to indicate interrupt by cpu access icache while"]
...
#[doc = "Field `CORE0_DBUS_ACS_MSK_ICACHE` reader - The bit is used to indicate interrupt by cpu access icache while"]
...
impl R {
    #[doc = "Bit 0 - The bit is used to indicate interrupt by cpu access icache while"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - The bit is used to indicate interrupt by cpu access icache while"]
    #[inline(always)]
