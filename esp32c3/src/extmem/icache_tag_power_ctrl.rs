...
#[doc = "Field `ICACHE_TAG_MEM_FORCE_ON` reader - The bit is used to close clock gating of icache tag memory."]
pub type ICACHE_TAG_MEM_FORCE_ON_R = crate::BitReader;
#[doc = "Field `ICACHE_TAG_MEM_FORCE_ON` writer - The bit is used to close clock gating of icache tag memory."]
pub type ICACHE_TAG_MEM_FORCE_ON_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `ICACHE_TAG_MEM_FORCE_PD` reader - The bit is used to power icache tag memory down 0: follow rtc_lslp"]
pub type ICACHE_TAG_MEM_FORCE_PD_R = crate::BitReader;
#[doc = "Field `ICACHE_TAG_MEM_FORCE_PD` writer - The bit is used to power icache tag memory down 0: follow rtc_lslp"]
...
impl R {
    #[doc = "Bit 0 - The bit is used to close clock gating of icache tag memory."]
    #[inline(always)]
    pub fn icache_tag_mem_force_on(&self) -> ICACHE_TAG_MEM_FORCE_ON_R {
        ICACHE_TAG_MEM_FORCE_ON_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - The bit is used to power icache tag memory down 0: follow rtc_lslp"]
    #[inline(always)]
