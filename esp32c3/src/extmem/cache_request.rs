...
#[doc = "Field `CACHE_REQUEST_BYPASS` reader - The bit is used to disable request recording which could cause performance issue"]
pub type CACHE_REQUEST_BYPASS_R = crate::BitReader;
#[doc = "Field `CACHE_REQUEST_BYPASS` writer - The bit is used to disable request recording which could cause performance issue"]
pub type CACHE_REQUEST_BYPASS_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    pub fn cache_request_bypass(&self) -> CACHE_REQUEST_BYPASS_R {
        CACHE_REQUEST_BYPASS_R::new((self.bits & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CACHE_REQUEST")
            .field("cache_request_bypass", &self.cache_request_bypass())
            .finish()
    }
}
impl W {
    #[doc = "Bit 0 - The bit is used to disable request recording which could cause performance issue"]
    #[inline(always)]
    pub fn cache_request_bypass(&mut self) -> CACHE_REQUEST_BYPASS_W<'_, CACHE_REQUEST_SPEC> {
        CACHE_REQUEST_BYPASS_W::new(self, 0)
    }
}
