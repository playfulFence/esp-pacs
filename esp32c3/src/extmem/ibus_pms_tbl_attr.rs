...
#[doc = "Field `IBUS_PMS_SCT1_ATTR` reader - The bit is used to configure attribute of the ibus permission"]
pub type IBUS_PMS_SCT1_ATTR_R = crate::FieldReader;
#[doc = "Field `IBUS_PMS_SCT1_ATTR` writer - The bit is used to configure attribute of the ibus permission"]
pub type IBUS_PMS_SCT1_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `IBUS_PMS_SCT2_ATTR` reader - The bit is used to configure attribute of the ibus permission"]
pub type IBUS_PMS_SCT2_ATTR_R = crate::FieldReader;
#[doc = "Field `IBUS_PMS_SCT2_ATTR` writer - The bit is used to configure attribute of the ibus permission"]
pub type IBUS_PMS_SCT2_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    #[doc = "Bits 0:3 - The bit is used to configure attribute of the ibus permission"]
    #[inline(always)]
    pub fn ibus_pms_sct1_attr(&self) -> IBUS_PMS_SCT1_ATTR_R {
        IBUS_PMS_SCT1_ATTR_R::new((self.bits & 0x0f) as u8)
    }
    #[doc = "Bits 4:7 - The bit is used to configure attribute of the ibus permission"]
    #[inline(always)]
