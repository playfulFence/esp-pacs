#[doc = "Register `CORE0_ACS_CACHE_INT_CLR` reader"]
pub type R = crate::R<CORE0_ACS_CACHE_INT_CLR_SPEC>;
#[doc = "Register `CORE0_ACS_CACHE_INT_CLR` writer"]
pub type W = crate::W<CORE0_ACS_CACHE_INT_CLR_SPEC>;
#[doc = "Field `CORE0_IBUS_ACS_MSK_IC` reader - The bit is used to clear interrupt by cpu access icache while"]
pub type CORE0_IBUS_ACS_MSK_IC_R = crate::BitReader;
#[doc = "Field `CORE0_IBUS_ACS_MSK_IC` writer - The bit is used to clear interrupt by cpu access icache while"]
pub type CORE0_IBUS_ACS_MSK_IC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CORE0_IBUS_WR_IC` reader - The bit is used to clear interrupt by ibus trying to write icache"]
...
#[doc = "Field `CORE0_IBUS_REJECT` reader - The bit is used to clear interrupt by authentication fail."]
...
#[doc = "Field `CORE0_DBUS_ACS_MSK_IC` reader - The bit is used to clear interrupt by cpu access icache while"]
pub type CORE0_DBUS_ACS_MSK_IC_R = crate::BitReader;
#[doc = "Field `CORE0_DBUS_ACS_MSK_IC` writer - The bit is used to clear interrupt by cpu access icache while"]
pub type CORE0_DBUS_ACS_MSK_IC_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CORE0_DBUS_REJECT` reader - The bit is used to clear interrupt by authentication fail."]
...
#[doc = "Field `CORE0_DBUS_WR_IC` reader - The bit is used to clear interrupt by dbus trying to write icache"]
...
impl R {
    #[doc = "Bit 0 - The bit is used to clear interrupt by cpu access icache while"]
    #[inline(always)]
    ...
    #[doc = "Bit 3 - The bit is used to clear interrupt by cpu access icache while"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CORE0_ACS_CACHE_INT_CLR")
...
#[doc = "\n\nYou can [`read`](crate::Reg::read) this register and get [`core0_acs_cache_int_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`core0_acs_cache_int_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CORE0_ACS_CACHE_INT_CLR_SPEC;
impl crate::RegisterSpec for CORE0_ACS_CACHE_INT_CLR_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [`core0_acs_cache_int_clr::R`](R) reader structure"]
impl crate::Readable for CORE0_ACS_CACHE_INT_CLR_SPEC {}
