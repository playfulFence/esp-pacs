...
#[doc = "Field `DBUS_PMS_SCT1_ATTR` reader - The bit is used to configure attribute of the dbus permission"]
pub type DBUS_PMS_SCT1_ATTR_R = crate::FieldReader;
#[doc = "Field `DBUS_PMS_SCT1_ATTR` writer - The bit is used to configure attribute of the dbus permission"]
pub type DBUS_PMS_SCT1_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
#[doc = "Field `DBUS_PMS_SCT2_ATTR` reader - The bit is used to configure attribute of the dbus permission"]
pub type DBUS_PMS_SCT2_ATTR_R = crate::FieldReader;
#[doc = "Field `DBUS_PMS_SCT2_ATTR` writer - The bit is used to configure attribute of the dbus permission"]
pub type DBUS_PMS_SCT2_ATTR_W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
impl R {
    #[doc = "Bits 0:1 - The bit is used to configure attribute of the dbus permission"]
    #[inline(always)]
    pub fn dbus_pms_sct1_attr(&self) -> DBUS_PMS_SCT1_ATTR_R {
        DBUS_PMS_SCT1_ATTR_R::new((self.bits & 3) as u8)
    }
    #[doc = "Bits 2:3 - The bit is used to configure attribute of the dbus permission"]
    #[inline(always)]
