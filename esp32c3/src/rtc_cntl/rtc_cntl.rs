...
#[doc = "Field `DIG_CAL_EN` reader - "]
pub type DIG_CAL_EN_R = crate::BitReader;
#[doc = "Field `DIG_CAL_EN` writer - "]
pub type DIG_CAL_EN_W<'a, REG> = crate::BitWriter<'a, REG>;
...
#[doc = "Field `REGULATOR_FORCE_PD` reader - RTC_REG force power down (for RTC_REG power down means decrease"]
pub type REGULATOR_FORCE_PD_R = crate::BitReader;
#[doc = "Field `REGULATOR_FORCE_PD` writer - RTC_REG force power down (for RTC_REG power down means decrease"]
...
impl R {
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn dig_cal_en(&self) -> DIG_CAL_EN_R {
        DIG_CAL_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    #[doc = "Bit 30 - RTC_REG force power down (for RTC_REG power down means decrease"]
    #[inline(always)]
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RTC_CNTL")
            ...
            .field("dig_cal_en", &self.dig_cal_en())
            .finish()
    }
}
impl W {
    #[doc = "Bit 7"]
    #[inline(always)]
    pub fn dig_cal_en(&mut self) -> DIG_CAL_EN_W<'_, RTC_CNTL_SPEC> {
        DIG_CAL_EN_W::new(self, 7)
    }
    #[doc = "Bits 14:21 - SCK_DCAP"]
    #[inline(always)]
