...
#[doc = "Field `FAST_CLK_RTC_SEL` reader - fast_clk_rtc sel. 0: XTAL div 2"]
pub type FAST_CLK_RTC_SEL_R = crate::BitReader;
#[doc = "Field `FAST_CLK_RTC_SEL` writer - fast_clk_rtc sel. 0: XTAL div 2"]
...
impl R {
    ...
    #[doc = "Bit 29 - fast_clk_rtc sel. 0: XTAL div 2"]
    #[inline(always)]
