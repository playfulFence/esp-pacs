...
#[doc = "Field `TIMER_CLK_IS_ACTIVE` reader - enable Timer $x's clock /"]
pub type TIMER_CLK_IS_ACTIVE_R = crate::BitReader;
#[doc = "Field `TIMER_CLK_IS_ACTIVE` writer - enable Timer $x's clock /"]
...
impl R {
    ...
    #[doc = "Bit 30 - enable Timer $x's clock /"]
    #[inline(always)]
