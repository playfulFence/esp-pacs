...
#[doc = "Field `LOAD_LO` reader - Low 32 bits of the value that a reload will load onto timer $x time-base Counter. /"]
pub type LOAD_LO_R = crate::FieldReader<u32>;
#[doc = "Field `LOAD_LO` writer - Low 32 bits of the value that a reload will load onto timer $x time-base Counter. /"]
pub type LOAD_LO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Low 32 bits of the value that a reload will load onto timer $x time-base Counter. /"]
    #[inline(always)]
