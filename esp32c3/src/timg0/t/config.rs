...
#[doc = "Field `DIVCNT_RST` writer - When set, Timer 0 's clock divider counter will be reset. /"]
pub type DIVCNT_RST_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DIVIDER` reader - Timer 0 clock (T0_clk) prescaler value. /"]
pub type DIVIDER_R = crate::FieldReader<u16>;
#[doc = "Field `DIVIDER` writer - Timer 0 clock (T0_clk) prescaler value. /"]
pub type DIVIDER_W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `AUTORELOAD` reader - When set, timer 0 auto-reload at alarm is enabled. /"]
pub type AUTORELOAD_R = crate::BitReader;
#[doc = "Field `AUTORELOAD` writer - When set, timer 0 auto-reload at alarm is enabled. /"]
pub type AUTORELOAD_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `INCREASE` reader - When set, the timer 0 time-base counter will increment every clock tick. When cleared, the timer 0 time-base counter will decrement. /"]
pub type INCREASE_R = crate::BitReader;
#[doc = "Field `INCREASE` writer - When set, the timer 0 time-base counter will increment every clock tick. When cleared, the timer 0 time-base counter will decrement. /"]
pub type INCREASE_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EN` reader - When set, the timer 0 time-base counter is enabled. /"]
pub type EN_R = crate::BitReader;
#[doc = "Field `EN` writer - When set, the timer 0 time-base counter is enabled. /"]
...
impl R {
    ...
    #[doc = "Bits 13:28 - Timer 0 clock (T0_clk) prescaler value. /"]
    #[inline(always)]
    pub fn divider(&self) -> DIVIDER_R {
        DIVIDER_R::new(((self.bits >> 13) & 0xffff) as u16)
    }
    #[doc = "Bit 29 - When set, timer 0 auto-reload at alarm is enabled. /"]
    #[inline(always)]
    pub fn autoreload(&self) -> AUTORELOAD_R {
        AUTORELOAD_R::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 30 - When set, the timer 0 time-base counter will increment every clock tick. When cleared, the timer 0 time-base counter will decrement. /"]
    #[inline(always)]
    pub fn increase(&self) -> INCREASE_R {
        INCREASE_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - When set, the timer 0 time-base counter is enabled. /"]
    #[inline(always)]
    pub fn en(&self) -> EN_R {
...
impl W {
    ...
    #[doc = "Bit 12 - When set, Timer 0 's clock divider counter will be reset. /"]
    #[inline(always)]
