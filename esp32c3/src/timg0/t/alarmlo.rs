...
#[doc = "Field `ALARM_LO` reader - Timer $x alarm trigger time-base counter value, low 32 bits. /"]
pub type ALARM_LO_R = crate::FieldReader<u32>;
#[doc = "Field `ALARM_LO` writer - Timer $x alarm trigger time-base counter value, low 32 bits. /"]
pub type ALARM_LO_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Timer $x alarm trigger time-base counter value, low 32 bits. /"]
    #[inline(always)]
