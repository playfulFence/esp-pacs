...
#[doc = "Field `UPDATE` reader - After writing 0 or 1 to TIMG_T$xUPDATE_REG, the counter value is latched. /"]
pub type UPDATE_R = crate::BitReader;
#[doc = "Field `UPDATE` writer - After writing 0 or 1 to TIMG_T$xUPDATE_REG, the counter value is latched. /"]
pub type UPDATE_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 31 - After writing 0 or 1 to TIMG_T$xUPDATE_REG, the counter value is latched. /"]
    #[inline(always)]
