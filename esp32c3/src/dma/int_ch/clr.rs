...
#[doc = "Field `IN_DONE` writer - Set this bit to clear the GDMA_IN_DONE_CH_INT interrupt. /"]
pub type IN_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_SUC_EOF` writer - Set this bit to clear the GDMA_IN_SUC_EOF_CH_INT interrupt. /"]
pub type IN_SUC_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_ERR_EOF` writer - Set this bit to clear the GDMA_IN_ERR_EOF_CH_INT interrupt. /"]
pub type IN_ERR_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_DONE` writer - Set this bit to clear the GDMA_OUT_DONE_CH_INT interrupt. /"]
pub type OUT_DONE_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_EOF` writer - Set this bit to clear the GDMA_OUT_EOF_CH_INT interrupt. /"]
pub type OUT_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_DSCR_ERR` writer - Set this bit to clear the GDMA_IN_DSCR_ERR_CH_INT interrupt. /"]
pub type IN_DSCR_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_DSCR_ERR` writer - Set this bit to clear the GDMA_OUT_DSCR_ERR_CH_INT interrupt. /"]
pub type OUT_DSCR_ERR_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `IN_DSCR_EMPTY` writer - Set this bit to clear the GDMA_IN_DSCR_EMPTY_CH_INT interrupt. /"]
pub type IN_DSCR_EMPTY_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUT_TOTAL_EOF` writer - Set this bit to clear the GDMA_OUT_TOTAL_EOF_CH_INT interrupt. /"]
pub type OUT_TOTAL_EOF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INFIFO_OVF` writer - Set this bit to clear the GDMA_INFIFO_OVF_L1_CH_INT interrupt. /"]
pub type INFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `INFIFO_UDF` writer - Set this bit to clear the GDMA_INFIFO_UDF_L1_CH_INT interrupt. /"]
pub type INFIFO_UDF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTFIFO_OVF` writer - Set this bit to clear the GDMA_OUTFIFO_OVF_L1_CH_INT interrupt. /"]
pub type OUTFIFO_OVF_W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `OUTFIFO_UDF` writer - Set this bit to clear the GDMA_OUTFIFO_UDF_L1_CH_INT interrupt. /"]
...
impl W {
    #[doc = "Bit 0 - Set this bit to clear the GDMA_IN_DONE_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn in_done(&mut self) -> IN_DONE_W<'_, CLR_SPEC> {
        IN_DONE_W::new(self, 0)
    }
    #[doc = "Bit 1 - Set this bit to clear the GDMA_IN_SUC_EOF_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn in_suc_eof(&mut self) -> IN_SUC_EOF_W<'_, CLR_SPEC> {
        IN_SUC_EOF_W::new(self, 1)
    }
    #[doc = "Bit 2 - Set this bit to clear the GDMA_IN_ERR_EOF_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn in_err_eof(&mut self) -> IN_ERR_EOF_W<'_, CLR_SPEC> {
        IN_ERR_EOF_W::new(self, 2)
    }
    #[doc = "Bit 3 - Set this bit to clear the GDMA_OUT_DONE_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn out_done(&mut self) -> OUT_DONE_W<'_, CLR_SPEC> {
        OUT_DONE_W::new(self, 3)
    }
    #[doc = "Bit 4 - Set this bit to clear the GDMA_OUT_EOF_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn out_eof(&mut self) -> OUT_EOF_W<'_, CLR_SPEC> {
        OUT_EOF_W::new(self, 4)
    }
    #[doc = "Bit 5 - Set this bit to clear the GDMA_IN_DSCR_ERR_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn in_dscr_err(&mut self) -> IN_DSCR_ERR_W<'_, CLR_SPEC> {
        IN_DSCR_ERR_W::new(self, 5)
    }
    #[doc = "Bit 6 - Set this bit to clear the GDMA_OUT_DSCR_ERR_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn out_dscr_err(&mut self) -> OUT_DSCR_ERR_W<'_, CLR_SPEC> {
        OUT_DSCR_ERR_W::new(self, 6)
    }
    #[doc = "Bit 7 - Set this bit to clear the GDMA_IN_DSCR_EMPTY_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn in_dscr_empty(&mut self) -> IN_DSCR_EMPTY_W<'_, CLR_SPEC> {
        IN_DSCR_EMPTY_W::new(self, 7)
    }
    #[doc = "Bit 8 - Set this bit to clear the GDMA_OUT_TOTAL_EOF_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn out_total_eof(&mut self) -> OUT_TOTAL_EOF_W<'_, CLR_SPEC> {
        OUT_TOTAL_EOF_W::new(self, 8)
    }
    #[doc = "Bit 9 - Set this bit to clear the GDMA_INFIFO_OVF_L1_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn infifo_ovf(&mut self) -> INFIFO_OVF_W<'_, CLR_SPEC> {
        INFIFO_OVF_W::new(self, 9)
    }
    #[doc = "Bit 10 - Set this bit to clear the GDMA_INFIFO_UDF_L1_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn infifo_udf(&mut self) -> INFIFO_UDF_W<'_, CLR_SPEC> {
        INFIFO_UDF_W::new(self, 10)
    }
    #[doc = "Bit 11 - Set this bit to clear the GDMA_OUTFIFO_OVF_L1_CH_INT interrupt. /"]
    #[inline(always)]
    pub fn outfifo_ovf(&mut self) -> OUTFIFO_OVF_W<'_, CLR_SPEC> {
        OUTFIFO_OVF_W::new(self, 11)
    }
    #[doc = "Bit 12 - Set this bit to clear the GDMA_OUTFIFO_UDF_L1_CH_INT interrupt. /"]
    #[inline(always)]
