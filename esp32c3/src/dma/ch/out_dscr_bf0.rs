...
#[doc = "Field `OUTLINK_DSCR_BF0` reader - Represents the address of the current transmit descriptor y that is pre-read. /"]
pub type OUTLINK_DSCR_BF0_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the address of the current transmit descriptor y that is pre-read. /"]
    #[inline(always)]
