...
#[doc = "Field `INLINK_DSCR` reader - Represents the address of the next receive descriptor x+1 pointed by the current receive descriptor that is pre-read. /"]
pub type INLINK_DSCR_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the address of the next receive descriptor x+1 pointed by the current receive descriptor that is pre-read. /"]
    #[inline(always)]
