...
#[doc = "Field `INLINK_DSCR_BF1` reader - Represents the address of the previous receive descriptor x-1 that is pre-read. /"]
pub type INLINK_DSCR_BF1_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Represents the address of the previous receive descriptor x-1 that is pre-read. /"]
    #[inline(always)]
