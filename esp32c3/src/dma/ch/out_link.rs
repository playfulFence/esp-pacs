...
#[doc = "Field `OUTLINK_STOP` reader - Set this bit to stop GDMA's transmit channel from transferring data. /"]
pub type OUTLINK_STOP_R = crate::BitReader;
#[doc = "Field `OUTLINK_STOP` writer - Set this bit to stop GDMA's transmit channel from transferring data. /"]
pub type OUTLINK_STOP_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `OUTLINK_START` reader - Set this bit to enable GDMA's transmit channel for data transfer. /"]
pub type OUTLINK_START_R = crate::BitReader;
#[doc = "Field `OUTLINK_START` writer - Set this bit to enable GDMA's transmit channel for data transfer. /"]
...
impl R {
    ...
    #[doc = "Bit 20 - Set this bit to stop GDMA's transmit channel from transferring data. /"]
    #[inline(always)]
    pub fn outlink_stop(&self) -> OUTLINK_STOP_R {
        OUTLINK_STOP_R::new(((self.bits >> 20) & 1) != 0)
    }
    #[doc = "Bit 21 - Set this bit to enable GDMA's transmit channel for data transfer. /"]
    #[inline(always)]
    ...
    #[doc = "Bit 23 - 1: the transmit descriptor's FSM is in idle state. 0: the transmit descriptor's FSM is working. /"]
    #[inline(always)]
