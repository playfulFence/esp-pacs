...
pub type ENABLE_DATA_R = crate::FieldReader<u32>;
#[doc = "Field `ENABLE_DATA` writer - "]
pub type ENABLE_DATA_W<'a, REG> = crate::FieldWriter<'a, REG, 26, u32>;
impl R {
    #[doc = "Bits 0:25"]
    #[inline(always)]
    pub fn enable_data(&self) -> ENABLE_DATA_R {
        ENABLE_DATA_R::new(self.bits & 0x03ff_ffff)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ENABLE")
            .field("enable_data", &self.enable_data())
            .finish()
    }
}
impl W {
    #[doc = "Bits 0:25"]
    #[inline(always)]
    pub fn enable_data(&mut self) -> ENABLE_DATA_W<'_, ENABLE_SPEC> {
        ENABLE_DATA_W::new(self, 0)
    }
}
