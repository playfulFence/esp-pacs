...
#[doc = "Field `RESERVED_FAIL` reader - 0: Means no failure and that the data of MAC_SPI_8M is reliable 1: Means that programming user data failed and the number of error bytes is over 6. /"]
pub type RESERVED_FAIL_R = crate::BitReader;
...
#[doc = "Field `MAC_SPI_8M_FAIL` reader - 0: Means no failure and that the data of system part1 is reliable 1: Means that programming user data failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `SYS_PART1_FAIL` reader - 0: Means no failure and that the user data is reliable 1: Means that programming user data failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `USR_DATA_FAIL` reader - 0: Means no failure and that the data of key0 is reliable 1: Means that programming key0 failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `KEY0_FAIL` reader - 0: Means no failure and that the data of key1 is reliable 1: Means that programming key1 failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `KEY1_FAIL` reader - 0: Means no failure and that the data of key2 is reliable 1: Means that programming key2 failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `KEY2_FAIL` reader - 0: Means no failure and that the data of key3 is reliable 1: Means that programming key3 failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `KEY3_FAIL` reader - 0: Means no failure and that the data of key4 is reliable 1: Means that programming key4 failed and the number of error bytes is over 6. /"]
...
impl R {
    ...
    #[inline(always)]
    pub fn reserved_fail(&self) -> RESERVED_FAIL_R {
        RESERVED_FAIL_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn mac_spi_8m_fail(&self) -> MAC_SPI_8M_FAIL_R {
        MAC_SPI_8M_FAIL_R::new(((self.bits >> 7) & 1) != 0)
    }
    ...
    pub fn sys_part1_fail(&self) -> SYS_PART1_FAIL_R {
        SYS_PART1_FAIL_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn usr_data_fail(&self) -> USR_DATA_FAIL_R {
        USR_DATA_FAIL_R::new(((self.bits >> 15) & 1) != 0)
    }
    ...
    pub fn key0_fail(&self) -> KEY0_FAIL_R {
        KEY0_FAIL_R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn key1_fail(&self) -> KEY1_FAIL_R {
        KEY1_FAIL_R::new(((self.bits >> 23) & 1) != 0)
    }
    ...
    pub fn key2_fail(&self) -> KEY2_FAIL_R {
        KEY2_FAIL_R::new(((self.bits >> 27) & 1) != 0)
    }
    ...
    pub fn key3_fail(&self) -> KEY3_FAIL_R {
        KEY3_FAIL_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_RS_ERR0")
            ...
            .field("reserved_fail", &self.reserved_fail())
