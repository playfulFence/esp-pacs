...
#[doc = "Field `DIS_USB_SERIAL_JTAG` reader - Represents whether USB-Serial-JTAG is disabled. 1: Disabled. 0: Enabled /"]
...
#[doc = "Field `DIS_TWAI` reader - Set this bit to disable CAN function. /"]
...
impl R {
    ...
    #[doc = "Bit 11 - Represents whether USB-Serial-JTAG is disabled. 1: Disabled. 0: Enabled /"]
    #[inline(always)]
