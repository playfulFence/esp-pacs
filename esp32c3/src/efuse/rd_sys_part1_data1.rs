...
#[doc = "Field `OPTIONAL_UNIQUE_ID_1` reader - Optional unique 128-bit ID /"]
pub type OPTIONAL_UNIQUE_ID_1_R = crate::FieldReader<u32>;
impl R {
    #[doc = "Bits 0:31 - Optional unique 128-bit ID /"]
    #[inline(always)]
    pub fn optional_unique_id_1(&self) -> OPTIONAL_UNIQUE_ID_1_R {
        OPTIONAL_UNIQUE_ID_1_R::new(self.bits)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_SYS_PART1_DATA1")
            .field("optional_unique_id_1", &self.optional_unique_id_1())
            .finish()
    }
}
