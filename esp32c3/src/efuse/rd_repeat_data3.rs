...
#[doc = "Field `DIS_DIRECT_BOOT` reader - Disable direct boot mode /"]
pub type DIS_DIRECT_BOOT_R = crate::BitReader;
#[doc = "Field `DIS_USB_SERIAL_JTAG_ROM_PRINT` reader - Represents whether USB printing is disabled or enabled. 1: Disabled. 0: Enabled /"]
...
#[doc = "Field `DIS_USB_SERIAL_JTAG_DOWNLOAD_MODE` reader - Disable UART download mode through USB-Serial-JTAG /"]
...
#[doc = "Field `RESERVED_0_158` reader - reserved /"]
pub type RESERVED_0_158_R = crate::BitReader;
#[doc = "Field `ERR_RST_ENABLE` reader - Use BLOCK0 to check error record registers /"]
pub type ERR_RST_ENABLE_R = crate::BitReader;
impl R {
    ...
    #[doc = "Bit 1 - Disable direct boot mode /"]
    #[inline(always)]
    pub fn dis_direct_boot(&self) -> DIS_DIRECT_BOOT_R {
        DIS_DIRECT_BOOT_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Represents whether USB printing is disabled or enabled. 1: Disabled. 0: Enabled /"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - Disable UART download mode through USB-Serial-JTAG /"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - reserved /"]
    #[inline(always)]
    pub fn reserved_0_158(&self) -> RESERVED_0_158_R {
        RESERVED_0_158_R::new(((self.bits >> 30) & 1) != 0)
    }
    #[doc = "Bit 31 - Use BLOCK0 to check error record registers /"]
    #[inline(always)]
    pub fn err_rst_enable(&self) -> ERR_RST_ENABLE_R {
        ERR_RST_ENABLE_R::new(((self.bits >> 31) & 1) != 0)
    }
}
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("RD_REPEAT_DATA3")
            ...
            .field("reserved_0_158", &self.reserved_0_158())
            .field("err_rst_enable", &self.err_rst_enable())
            .finish()
    }
}
