...
#[doc = "Field `KEY4_FAIL` reader - 0: Means no failure and that the data of KEY5 is reliable 1: Means that programming user data failed and the number of error bytes is over 6. /"]
...
#[doc = "Field `KEY5_FAIL` reader - 0: Means no failure and that the data of system part2 is reliable 1: Means that programming user data failed and the number of error bytes is over 6. /"]
...
impl R {
    ...
    pub fn key4_fail(&self) -> KEY4_FAIL_R {
        KEY4_FAIL_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    pub fn key5_fail(&self) -> KEY5_FAIL_R {
        KEY5_FAIL_R::new(((self.bits >> 7) & 1) != 0)
    }
}
