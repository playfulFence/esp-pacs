...
#[doc = "Field `CLK_EN` reader - Set this bit and force to enable clock signal of eFuse memory. /"]
pub type CLK_EN_R = crate::BitReader;
#[doc = "Field `CLK_EN` writer - Set this bit and force to enable clock signal of eFuse memory. /"]
...
impl W {
    ...
    #[doc = "Bit 16 - Set this bit and force to enable clock signal of eFuse memory. /"]
    #[inline(always)]
    pub fn clk_en(&mut self) -> CLK_EN_W<'_, CLK_SPEC> {
